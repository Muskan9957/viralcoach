    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 5% 80px' }}>
        ...
        <Section title="2. How We Use Your Information">
          ...
          <Ul items={[
            'Create and manage your Nuove account',
        ...
        <Section title="4. Cookies and Tracking">
          <P>Nuove uses minimal cookies and local storage for:</P>
          <Ul items={[
        ...
        <Section title="5. Third-Party Services">
          <P>We use the following third-party services to operate Nuove:</P>
          <Ul items={[
        ...
        <Section title="8. Children's Privacy">
          <P>Nuove is not intended for children under the age of 13. We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us and we will delete it immediately.</P>
        </Section>

        <Section title="9. Changes to This Policy">
          <P>We may update this Privacy Policy from time to time. When we do, we will update the "Last updated" date at the top of this page. For significant changes, we will notify you by email. Continued use of Nuove after changes are posted constitutes acceptance of the updated policy.</P>
        </Section>
