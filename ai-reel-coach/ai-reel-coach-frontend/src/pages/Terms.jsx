    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 5% 80px' }}>
        ...
        <div style={{
          ...
          These Terms of Service ("Terms") govern your use of <strong style={{ color: 'var(--text)' }}>Nuove</strong>, operated by <strong style={{ color: 'var(--text)' }}>Anahat Aura LLP</strong> ("Company", "we", "us"). By creating an account or using our service at <strong style={{ color: 'var(--text)' }}>anahatone.com</strong>, you agree to be bound by these Terms. If you do not agree, please do not use the service.
        </div>

        <Section title="1. Acceptance of Terms">
          <P>By accessing or using Nuove, you confirm that you are at least 13 years of age, have read and understood these Terms, and agree to be legally bound by them. If you are using Nuove on behalf of a business, you represent that you have authority to bind that business to these Terms.</P>
        </Section>

        <Section title="2. Description of Service">
          <P>Nuove is an AI-powered content creation platform that provides:</P>
          <Ul items={[
        ...
        <Section title="3. Account Registration">
          <P>To use Nuove, you must create an account. You agree to:</P>
          <Ul items={[
        ...
        <Section title="4. Acceptable Use">
          <P>You agree to use Nuove only for lawful purposes. You must not:</P>
          <Ul items={[
            ...
            'Resell or redistribute Nuove\'s AI-generated outputs as your own product or service',
        ...
        <Section title="5. Intellectual Property">
          <P><strong style={{ color: 'var(--text)' }}>Your content:</strong> You retain ownership of all content you input into Nuove (your topics, ideas, and uploaded materials). By using the service, you grant us a limited licence to process your input solely for the purpose of providing the service to you.</P>
          <P><strong style={{ color: 'var(--text)' }}>AI-generated content:</strong> Scripts, hooks, captions, and other content generated by Nuove's AI are provided for your personal and commercial use. You may use, publish, and monetise AI-generated content from Nuove.</P>
          <P><strong style={{ color: 'var(--text)' }}>Our platform:</strong> The Nuove platform, branding, logo, design, and underlying technology are the intellectual property of Anahat Aura LLP. You may not copy, reproduce, or use these without our written permission.</P>
        </Section>

        <Section title="6. Subscription and Payments">
          <P>Nuove offers a free plan and paid subscription plans. Paid plans are billed monthly or annually as selected at checkout.</P>
          <Ul items={[
        ...
        <Section title="8. AI-Generated Content Disclaimer">
          <P>Nuove uses artificial intelligence to generate content suggestions. You acknowledge that:</P>
          <Ul items={[
            ...
            'Nuove does not guarantee any specific results, views, followers, or revenue from using our service',
            'AI outputs should not be used as professional legal, financial, or medical advice',
          ]} />
        </Section>

        <Section title="9. Limitation of Liability">
          <P>To the maximum extent permitted by applicable law, Anahat Aura LLP shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of revenue, loss of data, or loss of business opportunities, arising from your use of Nuove.</P>
        ...
        <Section title="12. Changes to Terms">
          <P>We may update these Terms from time to time. When we do, we will update the "Last updated" date at the top of this page and notify you by email for significant changes. Continued use of Nuove after changes are posted constitutes your acceptance of the updated Terms.</P>
        </Section>
      ...
      <footer style={{
        ...
        <span>© Anahat Aura LLP · Nuove</span>
